...
- Read `PROJECT_STATUS.md` first, then only context and code relevant to the assigned task.
- Record owner, dependencies, allowed file scope, acceptance criteria, and verification evidence for meaningful tasks.
- Parallelize independent work freely; do not present dependent stages as parallel.
